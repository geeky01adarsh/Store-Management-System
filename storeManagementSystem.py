...
def DelProduct():
    pid=input("Enter the Productid to be deleted : ")
...
def ViewStock():
    item=input("Enter Product Name : ")
    sql="select product.product_id,product.PName,stock.Instock,\     stock.status from stock, product where \
